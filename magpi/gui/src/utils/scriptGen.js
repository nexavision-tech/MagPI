export const generatePythonScript = (nodes, connections, crs, processingScope) => {
    let script = `# Generated by MagPI Canvas (v0.1.49 Alpha)\n`;
    ...
    const getProvenance = (nodeId) => {
        ...
        if (['wfs_nlcd', 'wfs_census', 'load_vector', 'wfs_sciencebase', 'ia_reclassify'].includes(node.toolId)) return 'label';
    ...
    sortedNodes.forEach((n) => {
        ...
        // FIXED: Exposing the Reclassify tool translation correctly!
