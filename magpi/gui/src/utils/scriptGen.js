export const generatePythonScript = (nodes, connections, crs, processingScope) => {
    let script = `# Generated by MagPI Canvas (v0.1.10 Alpha)\n`;
    ...
    // FIX 2: Sort nodes strictly by X coordinate (Left-to-Right execution)
    ...
    sortedNodes.forEach((n) => {
        ...
        // FIX 1: Unpack complex UI parameter objects (like dropdowns) into raw values
        const p = {};
