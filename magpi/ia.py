        ...
        with rasterio.open(raster_path) as src_img:
            ...
            if src_lbl_raw:
                if src_lbl_raw.crs != src_img.crs or src_lbl_raw.transform != src_img.transform:
                    ...
                    # MUST use Nearest Neighbor for Categorical Labels to prevent AI confusion!
            ...
            for y in range(0, height - tile_size_y + 1, stride_y):
                for x in range(0, width - tile_size_x + 1, stride_x):
                    ...
                    # Write Image Chip and add NexaVision Meta properly
                    with rasterio.open(img_out, "w", **out_meta) as dest_img:
                        dest_img.write(img_array)
                        dest_img.update_tags(COPYRIGHT="Generated by MagPI - NexaVision.tech", SOFTWARE="MagPI v0.1.42 Alpha")
                    ...
                    if src_lbl:
                        ...
                        # Write Label Chip and add NexaVision Meta properly
                        with rasterio.open(lbl_out, "w", **lbl_meta) as dest_lbl:
                            dest_lbl.write(lbl_array)
                            dest_lbl.update_tags(COPYRIGHT="Generated by MagPI - NexaVision.tech", SOFTWARE="MagPI v0.1.42 Alpha")
