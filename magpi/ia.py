        ...
        with rasterio.open(raster_path) as src_img:
            ...
            for y in range(0, height - tile_size_y + 1, stride_y):
                for x in range(0, width - tile_size_x + 1, stride_x):
                    ...
                    # Write Image Chip (Injecting NexaVision Meta)
                    out_meta = src_img.meta.copy()
                    out_meta.update({
                        "height": tile_size_y, 
                        "width": tile_size_x, 
                        "transform": src_img.window_transform(window),
                        "TIFFTAG_COPYRIGHT": "Generated by MagPI - NexaVision.tech",
                        "TIFFTAG_SOFTWARE": "MagPI v0.1.41 Alpha"
                    })
                    ...
                    if src_lbl:
                        ...
                        # CRITICAL FIX: Base label meta on the image meta to guarantee 'GTiff' driver, 
                        # avoiding the 'VRTSourcedRasterBand' GDAL write crash!
